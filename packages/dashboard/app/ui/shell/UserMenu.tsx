...
export function UserMenu() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-1 min-w-48 rounded-xl border border-border bg-surface-overlay p-1 shadow-lg shadow-black/50 backdrop-blur-xl">
          <Link
            to="/user"
