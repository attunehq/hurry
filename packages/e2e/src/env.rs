...
impl TestEnv {
    ...
    /// Get the URL to access the Hurry API from within the Docker Compose network.
    ///
    /// Returns the internal service URL (e.g., "http://courier:3000") that
    /// containers can use to communicate with the Hurry API over the shared network.
