...
INSERT INTO api_key (id, account_id, name, hash, created_at, accessed_at, revoked_at) VALUES
  (1, 1, 'alice-primary', decode('fd69f4bc9b3cef00adeba62feedd4cbe0eaca7bf4875bff5bad544b4d96cde33', 'hex'), '2024-01-01 00:00:00+00', '2024-01-01 00:00:00+00', NULL),
  (2, 2, 'bob-primary', decode('80a4f0c064a7eb3f3aaf126bba6f74cab42e40717c865173f9fde9b46b54cc2a', 'hex'), '2024-01-01 00:00:00+00', '2024-01-01 00:00:00+00', NULL),
  (3, 3, 'charlie-primary', decode('8daf0ecd9b51b1b1bc57c34530e6406dd554afa6c4d11ee730aca8a498021254', 'hex'), '2024-01-02 00:00:00+00', '2024-01-02 00:00:00+00', NULL),
  (4, 1, 'alice-revoked', decode('209e0f7fe399a496966090284536e81018df959c1a3fafef0c819c2a08d571f0', 'hex'), '2024-01-01 00:00:00+00', '2024-01-01 00:00:00+00', '2024-01-15 00:00:00+00')
ON CONFLICT (id) DO NOTHING;
