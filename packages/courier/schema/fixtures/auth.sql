...
INSERT INTO organization (id, name, created_at) VALUES
  (2, 'Acme Corp', '2025-01-01 00:00:00+00'),
...
INSERT INTO account (id, organization_id, email, created_at) VALUES
  (1, 2, 'alice@acme.com', '2025-01-01 00:00:00+00'),
  (2, 2, 'bob@acme.com', '2025-01-01 00:00:00+00'),
...
INSERT INTO api_key (id, account_id, content, created_at, accessed_at, revoked_at) VALUES
  (1, 1, 'acme-alice-token-001', '2025-01-01 00:00:00+00', '2025-01-01 00:00:00+00', NULL),
  (2, 2, 'acme-bob-token-001', '2025-01-01 00:00:00+00', '2025-01-01 00:00:00+00', NULL),
  ...
  (5, 1, 'acme-alice-token-revoked', '2025-01-01 00:00:00+00', '2025-01-01 00:00:00+00', '2024-01-15 00:00:00+00')
ON CONFLICT (id) DO NOTHING;
